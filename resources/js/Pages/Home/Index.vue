    ...
    >
        ...
        <div class="max-w-2xl mx-auto p-6 lg:p-8">
            <main class="w-full flex flex-col items-center">
                <h1 class="mb-8 font-extrabold text-4xl text-center tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-violet-500 dark:from-violet-400 to-indigo-800 dark:to-indigo-500">Link Shortener</h1>

                <CreateAnonymousLinkForm />

                <small class="mt-6 text-sm text-gray-500">
                    Create an account to benefit from additional features such as an extended and customizable duration of your links, optional password protection, and more.
                </small>
            </main>
        </div>
    </div>
...
<script setup>
import CreateAnonymousLinkForm from "@/Pages/Home/Partials/CreateAnonymousLinkForm.vue";
